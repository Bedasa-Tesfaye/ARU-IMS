...
use App\Http\Controllers\SuperAdminAssignmentController;
...
Route::middleware('auth:web')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/approvals/history', [SuperAdminRegistrationController::class, 'getApprovalsHistory']);
        ...
        Route::post('/partner-requests/{id}/request-edit', [SuperAdminRegistrationController::class, 'requestPartnerEdit']);
        Route::get('/students/unassigned', [SuperAdminAssignmentController::class, 'unassignedStudents']);
        Route::get('/departments/{departmentId}/examiners', [SuperAdminAssignmentController::class, 'availableExaminers']);
        Route::get('/departments/{departmentId}/advisors', [SuperAdminAssignmentController::class, 'availableAdvisors']);
        Route::post('/assign/examiner', [SuperAdminAssignmentController::class, 'assignExaminer']);
        Route::post('/assign/advisor', [SuperAdminAssignmentController::class, 'assignAdvisor']);
        Route::post('/assign/both', [SuperAdminAssignmentController::class, 'assignBoth']);
