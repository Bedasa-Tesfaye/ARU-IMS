...
export const examinerAPI = {
  ...
  getStudentDocuments: (id) => http.get(`/api/examiner/students/${id}/documents`),
  ...
  updateVivaSchedule: (id, payload) => http.put(`/api/examiner/viva/${id}`, payload),
  cancelVivaSchedule: (id) => http.post(`/api/examiner/viva/${id}/cancel`),
  ...
  viewDocumentFile: (id) => http.get(`/api/examiner/documents/${id}/file`, { responseType: 'blob' }),
  downloadDocument: (id) => http.get(`/api/examiner/documents/${id}/download`, { responseType: 'blob' }),
...
export const advisorAPI = {
  ...
  deleteMeeting: (id) => http.delete(`/api/advisor/meetings/${id}`),
  ...
  viewDocumentFile: (id) => http.get(`/api/advisor/documents/${id}/file`, { responseType: 'blob' }),
  downloadDocument: (id) => http.get(`/api/advisor/documents/${id}/download`, { responseType: 'blob' }),
...
export const companyAPI = {
  ...
  viewDocumentFile: (id) => http.get(`/api/company/documents/${id}/file`, { responseType: 'blob' }),
  downloadDocument: (id) => http.get(`/api/company/documents/${id}/download`, { responseType: 'blob' }),
  ...
  updateSchedule: (id, payload) => http.put(`/api/company/schedule/${id}`, payload),
  deleteSchedule: (id) => http.delete(`/api/company/schedule/${id}`),
