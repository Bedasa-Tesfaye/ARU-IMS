...
import PublicInternships from '../components/PublicInternships';
...
const LandingPage = () => {
  ...
  const handleContactSubmit = (e) => {
    ...
    window.location.href = `mailto:super-admin@aru.edu.et?subject=${mailtoSubject}&body=${mailtoBody}`;
    setContactStatus('Your message is ready to send in your email client. Please complete and send it to super-admin@aru.edu.et.');
  };
  ...
  return (
    <div className="landing-page" onMouseMove={handleMouseMove}>
      ...
      <section id="home" className="hero">
        ...
        <div className="container">
          ...
          <div className="hero-image reveal delay-1">
            <div
              className="dashboard-preview parallax-element"
            ...
            >
              ...
              <div className="preview-top-bar">
                ...
                <div className="window-title">System Dashboard</div>
              </div>
              ...
              <div className="preview-content">
                ...
                <div className="preview-item">📝 Weekly Log Approved</div>
                <div className="preview-item">⭐ EthioTelecom Reviewed</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="features pattern-bg">
        <div className="container">
          ...
          <div className="features-grid">
            {[
              { icon: '🎓', title: 'For Students', desc: 'Apply for roles, submit digital reports, and manage your journey seamlessly.', features: ['Smart Matching', 'Digital Logbooks', 'Skill Tracking'] },
              { icon: '👨‍🏫', title: 'For Supervisors', desc: 'Monitor progress, review reports, and provide instant encrypted evaluations.', features: ['Batch Grading', 'Direct Messaging', 'Alert Triggers'] },
              { icon: '🏢', title: 'For Companies', desc: 'Source top talent, post openings, and manage intern lifecycles easily.', features: ['Talent Pools', 'Custom Evaluations', 'Offer Management'] },
              { icon: '📋', title: 'Coordinators', desc: 'Command center for the entire program with macro-level data analytics.', features: ['Auto-Assignments', 'Export Reports', 'Global Metrics'] }
            ].map((card, idx) => (
      ...
      {/* External Components wrapped in animation containers */}
      <div className="reveal"><UniversityInfo /></div>
      <div className="reveal"><SuccessStories /></div>
      <div className="reveal"><PublicInternships /></div>
      <div className="reveal"><PartnershipSection /></div>

      <section id="contact" className="contact-section reveal">
        <div className="container">
          <div className="section-header">
            <span className="section-tag">Contact</span>
            <h2 className="section-title">Send a Message to Super Admin</h2>
            <p className="section-subtitle">Thank you for reaching out to the super-admin team for support, account access, or internship assistance.</p>
          </div>

          <div className="contact-grid">
            <div className="contact-card">
              <h3>Need help from super admin?</h3>
              <p>
                Use this form to send a direct message to the super-admin support team. They will receive your inquiry and respond to your email address.
              </p>
            ...
            <form className="contact-form" onSubmit={handleContactSubmit}>
              ...
              <p className="contact-note">
                This will open your default email client and prepare a message to super-admin@aru.edu.et.
              </p>
            </form>
          </div>
        </div>
      ...
      <div className="reveal"><InteractiveDemo /></div>
      ...
      <section className="cta reveal">
        ...
        <div className="container relative-z glass-cta">
          ...
          <p>Join thousands of students and leading enterprises in the digital revolution.</p>
          <div className="cta-buttons">
            <a href="mailto:admin@aru.edu.et" className="btn-primary btn-large">Contact Admin</a>
