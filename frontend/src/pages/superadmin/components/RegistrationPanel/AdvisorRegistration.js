...
const AdvisorRegistration = ({ departments, onRegister, isSubmitting }) => {
  ...
  return (
    <form className="sa-registration-form" onSubmit={handleSubmit}>
      <div className="form-header">
        ...
        <p>Register a new academic advisor account</p>
      </div>
      ...
      <button type="submit" className="btn-submit" disabled={isSubmitting}>{isSubmitting ? 'Registering...' : '👨‍💼 Register Advisor'}</button>
    </form>
  );
};
